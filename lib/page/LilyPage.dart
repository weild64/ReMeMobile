        ...
        return MaterialApp(
          home: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                'Lily Livestream/Premier Schedule',
                style: TextStyle(color: Colors.pink.shade200),
              ),
              backgroundColor: Colors.lightBlue.shade100,
            ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          if (await canLaunch(
                              'https://www.youtube.com/LilyIfeta')) {
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          if (await canLaunch(
                              'https://www.instagram.com/lily_ifeta/')) {
                            await launch(
                                'https://www.instagram.com/lily_ifeta/');
                          }
                        },
